...
public class v12 implements Initializable{
    ...
    public void vote(ActionEvent event){
        try{
            ...
            if(ch > 2)
            {
                ...
                Parent p = FXMLLoader.load(getClass().getResource("v13.fxml"));
                stage.setScene(new Scene(p));
                stage.show();
            }
            else {

                Networking.output.writeUTF("Vote2");
                ...
                String m2 = "SELECT id FROM $t WHERE Name = "+"'"+name2+"'";
    ...
    public void initialize(URL arg0, ResourceBundle arg1) {
        ...
        try {
            Networking.output.writeUTF("Initialize2");
        }
    ...
    public void next(java.awt.event.ActionEvent e) throws IOException {
        ...
        Parent parent = FXMLLoader.load(getClass().getResource("v13.fxml"));
