...
public class ResultScreen2 implements Initializable{
    @FXML
    Button Prev_Button;
    @FXML
    Button Next_Button;
    ...
    {
                stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
                Parent Result2 = FXMLLoader.load(getClass().getResource("ResultScreen1.fxml"));
                stage.setScene(new Scene(Result2));
                stage.show();
    ...
    public void initialize(URL url, ResourceBundle resource) {
        ...
        try {
            ...
            cbox = "SELECT posts FROM posts WHERE id = 2";
            r = ss.executeQuery(cbox);
            r.next();
            ...
            if(su == 1){
                getDet2 = getDet2.replace("$t","Post2");
            }

            else{
                getDet2 = getDet2.replace("$t","Post"+(su*10+2));
            }
