...
public class ResultScreen3 implements Initializable{
    @FXML
    Button Prev_Button;
    @FXML
    Button Next_Button;
    ...
    public void Next(ActionEvent event)throws IOException{
        try {
            ...
            if (c > 3) {
                ...
                Parent Result2 = FXMLLoader.load(getClass().getResource("ResultScreen4.fxml"));
    ...
    public void initialize(URL url, ResourceBundle resource) {
        ...
        try {
            ...
            cbox = "SELECT posts FROM posts WHERE id = 3";
            r = ss.executeQuery(cbox);
            r.next();
            ...
            if(su == 1){
                getDet2 = getDet2.replace("$t","Post3");
            }

            else{
                getDet2 = getDet2.replace("$t","Post"+(su*10+3));
            }
